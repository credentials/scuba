...
public class Images
{
	...
	public static BufferedImage readImage(InputStream in, String mimeType, long imageLength, boolean isProgressiveMode) throws IOException {
	...
	private static BufferedImage readImage(InputStream in, ImageReader reader, long imageLength, boolean isProgressiveMode) throws IOException {
